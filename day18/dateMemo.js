...
//   li.innerHTML = `(${timeInput.value}) ${todoInput.value} <button value= "" class = "delete" type="button"> X </button>`
//   ul.appendChild(li)
//   let delBtns = document.querySelectorAll('.delete')
//   delText(delBtns)
// })

// function delText(delBtns) {
